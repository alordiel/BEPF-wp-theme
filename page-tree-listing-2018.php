										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-7 col-md-8 col-lg-12">
												...
												<?php if (get_field('tree_id') && 2 === 1): ?>
													<a class="btn-vote"
													   href="https://bepf-bg.org/дърво-с-корен/treec-voting?tree_id=<?php the_field('tree_id'); ?>"><img
										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-7 col-md-8 col-lg-12">
												...
												<?php if (get_field('tree_id') && 2 === 3): ?>
													<a class="btn-vote-c"
													   href="https://bepf-bg.org/дърво-с-корен/гласуване-за-вековните?tree_id=<?php the_field('tree_id'); ?>"><img
															src="<?php echo get_template_directory_uri(); ?>/lib/images/btn-vote-for.png"/></a>
												<?php endif; ?>
