<?php
/*
Template Name: [ДСК] Финалисти 2018
*/
?>
							...
							<?php 
												...
												<div class="col-xs-12 col-sm-7 col-md-8 col-lg-12">
													<div class="tree-excerpt">
														...
														<?php if( get_field('tree_type') ): ?>
															<p class=""><i class="fa fa-fw fa-leaf"></i><?php the_field( 'tree_type' ); ?></p>
														<?php endif; ?>
														<?php if( get_field('tree_age') ): ?>
															<p class=""><i class="fa fa-fw fa-birthday-cake"></i><?php the_field( 'tree_age' ); ?></p>
														<?php endif; ?>
														<?php if( get_field('tree_location') ): ?>
															<p class=""><i class="fa fa-fw fa-map-marker"></i><?php the_field( 'tree_location' ); ?></p>
														<?php endif; ?>
														<?php if( get_field('tree_nominator') ): ?>
															<p class=""><i class="fa fa-fw fa-user-plus"></i><?php the_field( 'tree_nominator' ); ?></p>
														<?php endif; ?>
														<?php if( get_field('tree_votes_display') == false ): ?>
															<!-- <p><i class="fa fa-fw fa-thumbs-up text-success"></i><?php echo get_votes_for(get_field('tree_id'),15); ?></p> -->
														<?php endif; ?>
													...
													<?php if( get_field('tree_id') && 2===1): ?>
														<a class="btn-vote" href="https://bepf-bg.org/дърво-с-корен/treec-voting?tree_id=<?php the_field( 'tree_id' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/lib/images/btn-vote-for.png" /></a>
													<?php endif; ?>
						        ...
						        ?>
							        ...
							        <div class="form-group">
								        <a id="btn-reset" class="btn btn-default"><?php _e("Back to Finalists", "wpbootstrap"); ?></a>
								      </div>
							    </div>
									<!-- Vote Form Ends -->
								</div>
								...
								<div id="chooser-c" class="row">
													...
													<div class="row">
														...
														<div class="col-xs-12 col-sm-7 col-md-8 col-lg-12">
															<div class="tree-excerpt">
																...
																<?php endif; ?>
																<?php if( get_field('tree_votes_display') == false ): ?>
																	<!-- <p><i class="fa fa-fw fa-thumbs-up text-success"></i><?php echo get_votes_for(get_field('tree_id'),16); ?></p> -->
																<?php endif; ?>
															...
															<?php if( get_field('tree_id') && 2 === 3): ?>
																<a class="btn-vote-c" href="https://bepf-bg.org/дърво-с-корен/гласуване-за-вековните?tree_id=<?php the_field( 'tree_id' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/lib/images/btn-vote-for.png" /></a>
															<?php endif; ?>
							        ...
							        <div class="form-group">
								        <a id="btn-reset-c" class="btn btn-default"><?php _e("Back to Finalists", "wpbootstrap"); ?></a>
								      </div>
							    </div>
