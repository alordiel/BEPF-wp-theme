...
$resources = [
	'webinars' => [
		'title' => 'Уебинари',
		'entries' => bepf_get_resource(3, 'webinar'),
	],
	'videos' => [
		'title' => 'Видео',
		'entries' => bepf_get_resource(3, 'media'),
	],
	'materials' => [
		'title' => 'Публикации и Материали',
		'entries' => bepf_get_resource(3, 'publications'),
	],
];
?>
	<section class="resources-landing">
								...
								<a href="<?php echo get_permalink($resource->ID); ?>"
								   title="<?php echo $resource->post_title ?>">
									<div class="resource-thumbnail"
										 style="background-image: url('<?php echo esc_url(get_the_post_thumbnail_url($resource->ID, 'full')); ?>')"></div>
		...
		<div class="container mb-5">
			<a href="/expert" class="like-orange-button" title="към всички експерти">Попитай експертите!</a>
			<div class="end-line"></div>
		</div>
	</section>
<?php
