						...
						<div class="container">
						    ...
						    <div class="col-xs-12 col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
						    	<div class="twr-home-page-image text-center">
										<h2 style="display:none;color: #fff;font-size: 3rem;font-weight: bold;margin-top: 55px;">Дърво с корен 2021</h2>
						    		...
						    		<img src="https://bepf-bg.org/bepf2015/wp-content/uploads/2017/09/ety_logo_RGB_PNG_1primary2.png" alt="Дърво с корен - лого" width="300">
						    	</div>
						    </div>
