...
{
	return (is_singular('resources') || is_singular('expert') || is_post_type_archive('resources') || is_post_type_archive('expert')  || in_array($page_template, ['page-resource-landing.php', 'page-resources-filters.php', 'page-resource-about-us.php']) || is_tax('resource-type'));
}
