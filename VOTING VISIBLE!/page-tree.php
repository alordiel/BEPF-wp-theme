				...
				<div id="main" class="col-sm-7 col-md-7 col-lg-7 clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<section class="post_content">
							...
							<?php endif; ?>
								<p><span class="label label-default"><?php _e("No of votes:", "wpbootstrap"); ?></span>&nbsp;<span class="text-success"><strong><?php echo get_votes_for(get_field('tree_id')); ?></strong></span></p>
							<hr>
							...
							<script type="text/javascript">
					            ...
					            jQuery("#twr_vote").bind("click", function () {
					                var url = "http://bepf-bg.org/bepf2015/tree-voting?tree_id=" + twr_tree_id;
