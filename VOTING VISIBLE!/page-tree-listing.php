...
<?php get_header('twr'); ?>
	...
	<div class="container">
			...
			<div id="content" class="row clearfix">
				...
				<div id="main" class="col-sm-10 col-md-10 clearfix" role="main">
										...
										<div class="col-xs-12 col-lg-15 col-tree">
											<div class="row">
												...
												<div class="col-xs-12 col-sm-7 col-md-8 col-lg-12">
													<div class="tree-excerpt">
														...
														<?php if( get_field('tree_votes_display') == false ): ?>
															<p><span class="label label-default"><?php _e("No of votes:", "wpbootstrap"); ?></span><span class="pull-right text-success"><strong><?php echo get_votes_for(get_field('tree_id')); ?></strong></span></p>
														<?php endif; ?>
												...
												<?php if( get_field('tree_id') ): ?>
													<a class="" href="http://bepf-bg.org/bepf2015/tree-voting?tree_id=<?php the_field( 'tree_id' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/lib/images/btn-vote-for.png" /></a>
												<?php endif; ?>
												...
												<div class="col-xs-12 col-lg-15 col-tree">
													<div class="row">
														...
														<div class="col-xs-12 col-sm-7 col-md-8 col-lg-12">
															...
															<?php endif; ?>
															<?php if( get_field('tree_votes_display') == false ): ?>
																<p><span class="label label-default"><?php _e("No of votes:", "wpbootstrap"); ?></span><span class="pull-right text-success"><strong><?php echo get_cvotes_for(get_field('tree_id')); ?></strong></span></p>
															<?php endif; ?>
														...
														<p class="text-right"><a class="text-success" href="<?php the_permalink(); ?>"><?php _e("Read more &raquo;", "wpbootstrap"); ?></a></p>
														<?php if( get_field('tree_id') ): ?>
															<a class="" href="http://bepf-bg.org/bepf2015/treec-voting?tree_id=<?php the_field( 'tree_id' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/lib/images/btn-vote-for.png" /></a>
														<?php endif; ?>
