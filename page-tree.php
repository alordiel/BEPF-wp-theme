		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
					...
					<section class="post_content">
						...
						<?php endif; ?>
						<!-- ACTIVE! -->
					<!-- <p><span class="label label-default"><?php _e("No of votes:", "wpbootstrap"); ?></span>&nbsp;<span class="text-success"><strong><?php echo get_votes_for(get_field('tree_id'), 19); ?></strong></span></p> -->
						<hr>
