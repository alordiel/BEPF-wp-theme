<?php
/*
Template Name: [ДСК] Финалисти 2016 Край
*/
?>
	...
	<div class="container">
						...
						<section class="post_content">
							...
							<?php //$this_page_id = $wp_query->post->ID;
												...
												<div class="col-xs-12 col-sm-7 col-md-8 col-lg-12">
													<div class="tree-excerpt">
														...
														<?php if( get_field('tree_type') ): ?>
															<p class=""><i class="fa fa-fw fa-leaf text-success"></i><?php the_field( 'tree_type' ); ?></p>
														<?php endif; ?>
														<?php if( get_field('tree_age') ): ?>
															<p class=""><i class="fa fa-fw fa-birthday-cake text-success"></i><?php the_field( 'tree_age' ); ?></p>
														<?php endif; ?>
														<?php if( get_field('tree_location') ): ?>
															<p class=""><i class="fa fa-fw fa-map-marker text-success"></i><?php the_field( 'tree_location' ); ?></p>
														<?php endif; ?>
														<?php if( get_field('tree_nominator') ): ?>
															<p class=""><i class="fa fa-fw fa-user-plus text-success"></i><?php the_field( 'tree_nominator' ); ?></p>
														<?php endif; ?>
													...
													<?php if( get_field('tree_id') ): ?>
														<a class="btn-vote" href="#<?php the_field( 'tree_id' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/lib/images/btn-vote-for.png" /></a>
													<?php endif; ?>
						        ...
						        ?>
							        ...
							        <div class="alert alert-danger lead">Гласуването приключи в 24:00 часа на 14 октомври 2016 г.</div>
												...
												<div class="col-xs-12 col-lg-15 col-tree">
													<div class="row">
														...
														<div class="col-xs-12 col-sm-7 col-md-8 col-lg-12">
															...
															<?php if( get_field('tree_id') ): ?>
																<a class="" href="http://bepf-bg.org/%D0%B4%D1%8A%D1%80%D0%B2%D0%BE-%D1%81-%D0%BA%D0%BE%D1%80%D0%B5%D0%BD/treec-voting?tree_id=<?php the_field( 'tree_id' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/lib/images/btn-vote-for.png" /></a>
															<?php endif; ?>
		...
		<script type="text/javascript">
			...
			$( ".btn-vote" ).click(function() {
				...
				$("#wdform_7_element11").val(voteValue);
			...
			$( ".btn-vote-c" ).click(function() {
			    var voteValue = $(this).attr("href").substr(1);
			    $("#wdform_7_element12").val(voteValue);
			    $(this).closest(".col-tree").toggleClass("chosen col-lg-4 col-lg-15");
			    //$(this).closest(".col-tree").removeClass("col-lg-15");
			    //$("#chooser > :not(.chosen)").hide();
