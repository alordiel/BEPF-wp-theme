<?php
/*
Template Name: [ДСК] Финалисти 2020
*/
?>
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<section class="post_content">
							...
							<div class="row">
								<div class="col-xs-12">									
									<h2 class="h2-finalists">Дърво с корен, финалисти 2020 г.</h2>
								</div>
							</div>
										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-7 col-md-8 col-lg-12">
												<div class="tree-excerpt">
													...
													<a href="<?php the_permalink(); ?>" style="display:block" title="виж повече">прочетете повече</a><br>
												...
												<!-- <?php if ( get_field('tree_id')) : ?>
													...
													<a class="btn-vote" href="<?php echo $vote_link ?>"><img src="<?php echo get_template_directory_uri(); ?>/lib/images/btn-vote-for.png" /></a>
												<?php endif; ?> -->
							...
							<div class="row">
								<div class="col-xs-12">
										<h2 class="h2-finalists">Вековните дървета говорят, финалисти 2020 г.</h2>
								</div>
							</div>
										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-7 col-md-8 col-lg-12">
												...
												<!-- <?php if ( get_field('tree_id')) : ?>
													...
													<a class="btn-vote-c" href="<?php echo $vote_link; ?>"><img src="<?php echo get_template_directory_uri(); ?>/lib/images/btn-vote-for.png" /></a>
												<?php endif; ?> -->
