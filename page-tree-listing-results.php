									...
									<div class="col-xs-12 col-lg-15 col-tree">
										<div class="row">
											<div class="col-xs-12 col-sm-5 col-md-4 col-lg-12">
												<img
													class="img-responsive" <?php $image = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'thumb-200');
												echo "src='" . $image['0'] . "'"; ?>/>
											</div>
											...
											<div class="col-xs-12 col-sm-7 col-md-8 col-lg-12">
												<div class="tree-excerpt">
													...
													<?php if (get_field('tree_type')): ?>
														<p class=""><span
																class="label label-default"><?php _e("Tree type:", "wpbootstrap"); ?></span><br/><?php the_field('tree_type'); ?>
														</p>
													<?php endif; ?>
													<?php if (get_field('tree_age')): ?>
														<p class=""><span
																class="label label-default"><?php _e("Age:", "wpbootstrap"); ?></span><br/><?php the_field('tree_age'); ?>
														</p>
													<?php endif; ?>
													<?php if (get_field('tree_location')): ?>
														<p class=""><span
																class="label label-default"><?php _e("Location:", "wpbootstrap"); ?></span><br/><?php the_field('tree_location'); ?>
														</p>
													<?php endif; ?>
													<?php if (get_field('tree_nominator')): ?>
														<p class=""><span
																class="label label-default"><?php _e("Nominator:", "wpbootstrap"); ?></span><br/><?php the_field('tree_nominator'); ?>
														</p>
													<?php endif; ?>
							...
							<div class="row">
								...
								while (have_posts()) : the_post(); ?>
									...
									<div class="col-xs-12 col-lg-15 col-tree">
										...
										<?php if (get_field('tree_id')): ?>
											<a class=""
											   href="http://bepf-bg.org/treec-voting?tree_id=<?php the_field('tree_id'); ?>"><img
													src="<?php echo get_template_directory_uri(); ?>/lib/images/btn-vote-for.png"/></a>
										<?php endif; ?>
